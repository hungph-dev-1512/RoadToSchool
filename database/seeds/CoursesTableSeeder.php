...
class CoursesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Course::create([
            'title' => 'Git',
            'course_avatar' => config('app.image') . 'course_avatar/git1.png',
            'course_avatar_2' => config('app.image') . 'course_avatar/git2.png',
            'course_avatar_3' => config('app.image') . 'course_avatar/git3.png',
        ...
        Course::create([
            'title' => 'Mysql',
            'course_avatar' => config('app.image') . 'course_avatar/mysql1.jpg',
            'course_avatar_2' => config('app.image') . 'course_avatar/mysql2.png',
            'course_avatar_3' => config('app.image') . 'course_avatar/mysql3.png',
        ...
        Course::create([
            'title' => 'Laravel',
            'course_avatar' => config('app.image') . 'course_avatar/laravel1.jpg',
            'course_avatar_2' => config('app.image') . 'course_avatar/laravel2.png',
            'course_avatar_3' => config('app.image') . 'course_avatar/laravel3.jpeg',
