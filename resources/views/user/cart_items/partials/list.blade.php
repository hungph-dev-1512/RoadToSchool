<div class="col-sm-9 page-content" id="cart">
    <div class="inner-box">
        ...
        @if($courseRelationsInCart->isEmpty())
            <image src="/assets/img/empty_cart.png" alt="Empty cart" style="display: block;margin-left: auto;margin-right: auto;width: 50%;"></image><br>
            <h4 class="text-center"> {{ __('messages.your_cart_is_empty_keep_shopping') }} </h4><br>
            <a class="btn btn-common btn-search btn-block" href="{{ route('home') }}" style="width: max-content;margin: 0 auto";><strong>{{ __('titles.keep_shopping') }}</strong></a>
        @else
                    ...
                    @if($courseRelation->cart_item_type === \App\Models\CartItem::IN_CART_TYPE)
                        <tr id="cart-item-{{$courseRelation->id}}">
                            ...
                            <td class="ads-details-td">
                                ...
                                <p><strong> {{ __('titles.seller') }} </strong>: {{ $courseRelation->course->seller }}
                            ...
                            <td class="action-td">
                                ...
                                <p><a class="btn btn-info btn-xs save-for-later" data-id="{{ $courseRelation->id }}"
                                      id="save-for-later-{{$courseRelation->id}}"> <i
                                                class="fa fa-share-square-o"></i> {{ __('titles.save_for_later') }} </a>
                                </p>
