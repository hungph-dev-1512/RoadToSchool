            ...
            <div class="user-panel-sidebar">
                <div class="collapse-box">
                    ...
                    <div aria-expanded="true" id="myclassified" class="panel-collapse collapse in">
                        <ul class="acc-list">
                            <li id="personal-page">
                                <a href="{{ route('users.show', Auth::user()->id) }}"><i class="fa fa-user"></i> {{ __('titles.personal_page') }} </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="collapse-box">
                        <h5 class="collapset-title"> {{ __('titles.cart') }} <a aria-expanded="true" class="pull-right" data-toggle="collapse" href=""><i class="fa fa-angle-down"></i> </a></h5>
                        <div aria-expanded="true" id="myads" class="panel-collapse collapse in">
                            <ul class="acc-list">
                                <li id="my-cart">
                                    <a href="{{ route('cart_items.index') }}"><i class="fa fa-shopping-cart"></i>&ensp;&ensp; {{ __('titles.my_cart') }} <span class="badge">19</span></a>
                                </li>
                                <li>
                                    <a href="#saved-for-later"><i class="fa fa-star-o"></i>&ensp;&ensp; {{ __('titles.saved_for_later') }} <span class="badge">19</span></a>
                                </li>
                                <li>
                                    <a href="#wishlist"><i class="fa fa-heart-o"></i>&ensp;&ensp; {{ __('titles.wishlist') }} <span class="badge">19</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
